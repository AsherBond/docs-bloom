...
As mentioned in xref:../bloom-installation/bloom-deployment-modes.adoc#bloom-in-aura[Bloom in Neo4j Aura], Bloom is available in the Aura console.

The link format for Bloom in the Aura console is as follows:
...
If you want to link directly to the Bloom app in the console, the link format is as follows:

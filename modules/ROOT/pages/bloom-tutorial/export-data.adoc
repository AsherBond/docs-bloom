...
[WARNING]
====
If you are connected to an Aura instance, note that *pausing the instance results in the loss of any saved Scenes*.
Make sure to export the Scene in Bloom before pausing the instance in the Aura console to preserve your Scene, as described in <<sharing-options>>.
====
...
Such changes include backup and restore actions.
====
...
[.shadow]
image::share-options1.png[width=400]

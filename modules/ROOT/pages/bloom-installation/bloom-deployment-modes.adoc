...
As mentioned in xref::/about-bloom.adoc#desktop-hosted[Neo4j Desktop hosted], Bloom is available in Neo4j Desktop.
...
== Bloom in Neo4j Desktop

*Without the server plugin*

In this mode, built-in Bloom can connect to a Neo4j database locally created in Desktop only.
...
* Through Bloom in the Neo4j Aura console
...
It contains the Neo4j Aura Studio that consists of the functionality of Neo4j Browser, Neo4j Data Importer, Bloom, and it also offers various other functionalities from the Neo4j product catalog.
In the Aura console, Bloom remains Bloom, but the Browser equivalent is called _Query_ and the Data Importer equivalent is called _Import_.
Bloom in Aura offers essentially the same features as the standalone Bloom.
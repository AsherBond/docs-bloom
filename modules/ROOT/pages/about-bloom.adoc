...
It is also available in the Neo4j Aura console or as a standalone application at `bloom.neo4j.io`.
...
Bloom is available for free in Neo4j Desktop for local databases and does not require installation.
